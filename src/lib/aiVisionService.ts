...
function generateCurriculumQuestionData(params: {
  ...
  if (cleanSubj.includes('คณิต') || cleanSubj.includes('math')) {
    // Exact indicator-aware Math item templates
    ...
    if (
      ...
      // ค 1.1 ป.5/5: โจทย์ปัญหาเศษส่วน 2 ขั้นตอน
      matchedTemplates = [
        {
      ...
      // ค 1.1 ป.5/2: โจทย์ปัญหาบัญญัติไตรยางศ์
      matchedTemplates = [
        {
      ...
      // ค 1.1 ป.5/1: เขียนเศษส่วนในรูปทศนิยม
      matchedTemplates = [
        {
      ...
      // ค 1.1 ป.5/6, ป.5/7, ป.5/8: การดำเนินการของทศนิยม
      matchedTemplates = [
        {
      ...
      // ค 2.2: รูปเรขาคณิตสามมิติ ปริมาตรและความจุ
      matchedTemplates = [
        {
      ...
      // General fallback math aligned with indicator
      matchedTemplates = [
        {
    ...
    // Science bank matched with concepts
    let sciTemplates = [
      {
    ...
    if (indMatchStr.includes('แรง') || indMatchStr.includes('การเคลื่อนที่')) {
      sciTemplates = [sciTemplates[3]];
    } else if (indMatchStr.includes('สาร') || indMatchStr.includes('เคมี') || indMatchStr.includes('การเปลี่ยนแปลง')) {
      sciTemplates = [sciTemplates[2]];
    } else if (indMatchStr.includes('สิ่งมีชีวิต') || indMatchStr.includes('ระบบนิเวศ') || indMatchStr.includes('โซ่อาหาร')) {
      sciTemplates = [sciTemplates[1]];
    } else if (indMatchStr.includes('พืช') || indMatchStr.includes('สังเคราะห์ด้วยแสง')) {
      sciTemplates = [sciTemplates[0]];
    }
