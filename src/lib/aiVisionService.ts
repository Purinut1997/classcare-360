...
export async function parseScheduleImage(
  ...
  const prompt = `
คุณคือ AI ผู้เชี่ยวชาญการถอดรหัสเอกสารตารางสอน/ตารางเรียนของโรงเรียนไทย (มาตรฐาน สพฐ.)
จงอ่านและแปลงข้อมูลในภาพตารางสอนที่แนบมานี้ ให้เป็นรูปแบบ JSON ตามโครงสร้างด้านล่างอย่างเคร่งครัด:

{
  "courseTitle": "ชื่อหัวตาราง เช่น ตารางสอนประจำสัปดาห์ ชั้น ป.5/1 (ถ้ามี)",
  "teacherName": "ชื่อครูผู้สอน หรือครูประจำชั้น (ถ้ามีระบุในตาราง)",
  "periodCount": 7,
  "startTime": "08:30",
  "periodMinutes": 50,
  "lunchStart": "11:30",
  ...
  "cells": [
    {
      "day": "จันทร์",
      "periodIndex": 1,
      "subjectCode": "รหัสวิชา เช่น HR หรือ ท15101",
      "subjectName": "ชื่อวิชา เช่น โฮมรูม หรือ ภาษาไทย",
      "classroom": "${defaultClassroom}",
      "teacherName": "ชื่อครูผู้สอนในคาบนี้ (ถ้ามี)"
    }
  ],
...
3. ช่องที่เป็น "พักเที่ยง" หรือ "พักกลางวัน" หรือช่องว่างไม่ต้องใส่ลงใน cells
4. หากช่องระบุทั้งรหัสวิชาและชื่อวิชา (เช่น "ค15101 คณิตศาสตร์") ให้แยกเก็บใน subjectCode และ subjectName
