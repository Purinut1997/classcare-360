-- Verify and fix set_student_public_lookup_identity function
-- This migration ensures the function exists with correct permissions

-- Drop and recreate the function to ensure it's properly set up
drop function if exists public.set_student_public_lookup_identity(uuid, text);

create function public.set_student_public_lookup_identity(
...
grant execute on function public.set_student_public_lookup_identity(uuid, text) to anon;
