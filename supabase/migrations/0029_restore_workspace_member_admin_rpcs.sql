-- Repair migration drift observed in production: migration 0012 was recorded
-- as applied, but its workspace member administration RPCs were absent from
...
revoke all on function public.can_manage_workspace_members(uuid) from public;
